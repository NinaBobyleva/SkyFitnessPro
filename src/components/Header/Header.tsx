...
import logoImg from '/src/assets/logo.svg'; // Путь к вашему изображению в проекте Vite
import ButtonHeader from '../ButtonHeader/ButtonHeader'; // Убедитесь, что путь к компоненту корректен
