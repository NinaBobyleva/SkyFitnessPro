...
import Button from '../Button/Button'; // Проверьте, что путь правильный
import WorkoutProgress from "../WorkoutProgress/WorkoutProgress"; // Проверьте, что путь правильный
    ...
    >
      <div title="">
        <img
          ...
          src={imgURL} // Используйте imgURL напрямую
          alt={title}
          width={360}
          height={325} // Высота изображения в пределах карточки
        />
