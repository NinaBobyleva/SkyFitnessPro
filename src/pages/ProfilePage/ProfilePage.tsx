...
//       if (user) {
//         setUser(user);
//         // Запрашиваем сохраненное имя пользователя из базы данных Firebase
...
//     set(ref(database, `users/${auth.currentUser.uid}/displayName`), name);
//   };
...
//                   <input type="text" value={name} onChange={handleNameChange} className="mr-4" />
